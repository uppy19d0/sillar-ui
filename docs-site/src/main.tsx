...
const examples = [
  ...
  { name: 'Select + Combobox', node: <div className="demo-stack"><Sillar.SelectRoot defaultValue="do"><Sillar.SelectTrigger aria-label="Country"><Sillar.SelectValue /></Sillar.SelectTrigger><Sillar.SelectContent><Sillar.SelectGroup><Sillar.SelectLabel>Caribbean</Sillar.SelectLabel><Sillar.SelectItem value="do">Dominican Republic</Sillar.SelectItem><Sillar.SelectItem value="pr">Puerto Rico</Sillar.SelectItem></Sillar.SelectGroup><Sillar.SelectSeparator /><Sillar.SelectGroup aria-label="North America"><Sillar.SelectItem value="us">United States</Sillar.SelectItem><Sillar.SelectItem value="ca">Canada</Sillar.SelectItem></Sillar.SelectGroup></Sillar.SelectContent></Sillar.SelectRoot><Sillar.Combobox placeholder="Search a city" options={[{ value: 'sdq', label: 'Santo Domingo' }, { value: 'sti', label: 'Santiago' }, { value: 'nyc', label: 'New York' }]} /></div> },
...
const keyboardRows = [
  ['Dialog / Popover', 'Escape', 'Close and restore focus'], ['Accordion', 'Arrow keys · Home · End', 'Move between headers'], ['Select / Menu', 'Arrows · Home · End · Escape · Typeahead', 'Navigate, search, select, dismiss'], ['Combobox', 'Arrows · Enter · Escape', 'Filter and choose an option'], ['DatePicker', 'Arrows · Home · End · PageUp/Down', 'Navigate days, weeks, and months'], ['Tabs / RadioGroup', 'Arrow keys', 'Move and activate choices'],
];
